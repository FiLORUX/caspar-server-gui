// Origin discipline for the caspar-server-gui Pages project.
//
// This project is served to the public by the tsg-proxy Worker under
// /keyfill on tsg.thast.live; its own *.pages.dev hostname is an origin,
// never a surface. A request that reaches the origin name directly answers 308
...
const PRODUCTION_ORIGIN = 'caspar-server-gui.pages.dev';
const CANONICAL = 'https://tsg.thast.live/keyfill';
